...
const Logo = ({ color }: { color?: string }) => {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <path d="M0 0 C143.22 0 286.44 0 434 0 C434 181.17 434 362.34 434 549 C290.78 549 147.56 549 0 549 C0 367.83 0 186.66 0 0 Z " fill={color || "#000"}/>
    </svg>
  );
};
